...
function EmptyState({ onReset }) {
  return (
    <div className="empty-state">
      <svg viewBox="0 0 672.5315 700" className="empty-state__svg">
        {/* UFO */}
        <g className="ufo">
          <path
        ...
        {/* Minion 1 - ground, left side */}
        <g className="minion1" transform="translate(-25,163)">
      ...
      <h3 className="empty-state__title">No Signal Found</h3>
      <p className="empty-state__text">
        Looks like there's nothing out here matching your filters.
      </p>
